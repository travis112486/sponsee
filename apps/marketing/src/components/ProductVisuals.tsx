          ...
          {(
            [
              ...
              },
              {
                ...
                total: "$3,200",
                deals: [
                  { brand: "Qavernix VPN", amount: "$2,400", platform: "twitch", meta: "6d in stage", metaTone: "amber" },
        ...
        <div className="rounded-lg border border-hairline bg-surface p-3 shadow-warm">
          <div className="flex items-center justify-between gap-2">
            <span className="flex items-center gap-1.5">
              ...
              <span className="text-[11px] font-medium text-ink">Qavernix VPN · INV-014</span>
            </span>
